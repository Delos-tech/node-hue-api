...
/**
 * @typedef {import('@delos-tech/hue-bridge-model').model.Entertainment} Entertainment
 * @typedef {import('@delos-tech/hue-bridge-model').model.Group} Group
 * @typedef {import('@delos-tech/hue-bridge-model').model.LightGroup} LightGroup
 * @typedef {import('@delos-tech/hue-bridge-model').model.Lightsource} Lightsource
 * @typedef {import('@delos-tech/hue-bridge-model').model.Luminaire} Luminaire
 * @typedef {import('@delos-tech/hue-bridge-model').model.Room} Room
 * @typedef {import('@delos-tech/hue-bridge-model').model.Zone} Zone
 */
