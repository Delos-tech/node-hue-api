...
const Bottleneck = require('bottleneck')
  ...
  , util = require('../util')
  , Light = require('@delos-tech/hue-bridge-model').model.Light
;

/**
 * @typedef {import('@delos-tech/hue-bridge-model').model.Light} Light
 * @typedef {import('@delos-tech/hue-bridge-model').model.LightState} LightState
 * @type {Lights}
 */
